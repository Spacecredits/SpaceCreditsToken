/*
 _________                         _________                    .___.__  __          
 /   _____/__________    ____  ____ \_   ___ \_______   ____   __| _/|__|/  |_  ______
 \_____  \\____ \__  \ _/ ___\/ __ \/    \  \/\_  __ \_/ __ \ / __ | |  \   __\/  ___/
 /        \  |_> > __ \\  \__\  ___/\     \____|  | \/\  ___// /_/ | |  ||  |  \___ \ 
/_______  /   __(____  /\___  >___  >\______  /|__|    \___  >____ | |__||__| /____  >
        \/|__|       \/     \/    \/        \/             \/     \/               \/ 
...
contract SpaceCredits is Context, IBEP20, Ownable {
    using SafeMath 
for
 uint256;
    using Address 
...
0
    ...
    uint256 private constant _allTotalSupply = 
100000000
 * 
10
**
...
return
 (_rTotalSupply, _allTotalSupply);
            rSupply = rSupply.sub(_rOwned[_excluded[i]]);
            tSupply = tSupply.sub(_tOwned[_excluded[i]]);
        }
        
if
 (rSupply < _rTotalSupply.div(_allTotalSupply)) 
return
 (_rTotalSupply, _allTotalSupply);
